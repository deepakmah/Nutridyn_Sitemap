 ...
 *
 * Key points:
 *  • TC03 and TC04 both depend only on TC02 — a sitemap timeout in TC03
 *    does NOT cause TC04 to be skipped.
 *  • @AfterSuite(alwaysRun=true) emails the report whether tests pass or fail.
 */
public class NutridynE2ETest {
    ...
    /** Always fires after the full suite — sends email even if tests failed. */
    ...
    // TC04 depends on TC02 only — runs independently of TC03
    @Test(dependsOnMethods = "TC02_loginPatient",
